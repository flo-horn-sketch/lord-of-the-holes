  function startFlightReveal(drawToReveal = null) {
    ...
    const drawComesFromFreshServerLoad = Boolean(drawToReveal?.rounds?.length);

    if ((!flightDrawLoadedFromServer && !drawComesFromFreshServerLoad) || !nextDraw?.rounds?.length) {
    ...
    setFlightDraw(nextDraw);import React, { useEffect, useMemo, useRef, useState } from "react";
