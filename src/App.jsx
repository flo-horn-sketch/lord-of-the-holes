...
function LordOfTheHolesApp() {
  ...
  async function enterRoundFromSplash() {
    ...
    if (!readLocalJson("lordOfTheHoles.myPlayerId", "")) setForceMyPlayerPromptOpen(true);
