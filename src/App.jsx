      ...
      <div className="rounded-3xl border border-amber-400/45 bg-black/62 p-3 text-left text-amber-50 shadow-2xl shadow-black/70 backdrop-blur-sm">
        <div className="text-center">
          ...
          <div className="mt-2 rounded-2xl border border-amber-400/30 bg-black/35 p-2 text-center">
            <div className="font-serif text-xl font-black text-amber-100">Hier live</div>
          </div>
