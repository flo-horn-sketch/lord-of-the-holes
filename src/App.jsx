...
function LordOfTheHolesApp() {
  ...
  async function saveFullSetup() {
    ...
    const nextAllPlayers = allPlayers.map((p) => {
      ...
      return { ...nextPlayer, course_hcp_goethe: getCourseHandicap(nextPlayer, "goethe", coursesForUse), course_hcp_feininger: getCourseHandicap(nextPlayer, "feininger", coursesForUse), course_hcp_hofhausen: getCourseHandicap(nextPlayer, "hofhausen", coursesForUse) };
    });
